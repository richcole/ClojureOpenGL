...
public class MarchingCubes implements Tessellation {
  ...
  static Vector     CUBE_VERTS_TABLE[] = { new Vector(0, 0, 0, 1), new Vector(1, 0, 0), new Vector(1, 1, 0),
    new Vector(0, 1, 0), new Vector(0, 0, 1), new Vector(1, 0, 1), new Vector(1, 1, 1), new Vector(0, 1, 1) };
